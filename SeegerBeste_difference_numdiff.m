function [ sigma, i ] = SeegerBeste_difference_numdiff( E, K_, n_, K_p, sigma_e, mode,eps)
%SeegerBeste_difference_numdiff performs the notch root approximation according to the
% the Seeger and Beste approach. The derivative is approximated using finite
% differences.
% The root finding problem is formulated using the difference between
...
%
%[ sigma ] = SeegerBeste_difference_numdiff( E, K_, n_, K_p, sigma_e, mode)
%
%Parameter:
%   E           - Youngs Modulus 
